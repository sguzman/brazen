...
- [ ] Cache policy config exists
- [ ] Metadata/body/archive mode knobs exist in config
- [ ] MIME allowlist and size threshold knobs exist in config
- [ ] Basic capture and indexing implementation exists
...
- [ ] CLI cache fetch + stats for on-demand captures
